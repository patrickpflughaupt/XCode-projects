...
class ViewController: UIViewController {
    ...
    var popup = UILabel()
    var array = ["European Countries", "Asian Countries", "Cold Countries", "Hot Countries", "World Capitals",
                 "UK Cities", "US States", "World Politicans", "World Political Parties",
                 "Disney Movies", "Hollywood Actors", "Hollywood Actresses", "Action Movies",
                 "Movie Genres", "Music Genres", "Royal Titles", "Award Shows",
                 "Music Bands", "Female Singers", "Male Singers", "Composers", "Film Directors",
                 "Types of Fruit", "Types of Vegetables", "What You Eat for Breakfast",
                 "What You Eat for Dinner", "Seasonings and Sauces", "Junk Food",
                 "Items That Are Frozen", "Ice Cream Flavours", "Fast Food Restaurants",
                 ...
                 "Currencies", "Emotions", "Positions in the Company", "Elements in the Periodic Table",
                 "Book Genres", "Units", "Things You Bring on Holidays", "Things Found on a Map",
                 "Things You Hang on the Wall", "Sounds of Things", "School Supplies", "Things That Jiggle",
                 "Reasons a Child is Grounded", "Things You Find in a Forest",
                 "Things You Encounter on Your Way to Work",
                 "Things You Do After You Wake Up", "Toppings on Pizza", "Types of Drugs", "Things You Did Today",
                 "Things That Cost a Lot", "Things That You Lose", "Things That Burn",
                 "Natural Disasters", "Musical Instruments", "Musical Names", "Street Names",
                 "Animal Actions", "Actions in the House", "Name of Songs",
                 "Colours", "Things That Use Batteries", "Things That Are Alive", "Things That Are Green",
                 "Things That Use Electricity", "Things That Fly", "Things You Can See From the Airplane Window",
                 "Things That You Wear on Your Head", "Things That Float", "Things with Wheels", "Things in Space",
                 "Things You Plug in", "Things Made of Glass", "Things Made of Wood",
                 "Things That You Can Turn on and off", "Things with Buttons", "Things in the Kitchen",
                 "Things in the Bathroom", "Things in the Bedroom", "Things in the Living Room",
                 "Things in the Garden", "Things a Baby Has", "Things in a Shopping Mall",
                 "Things That Grow", "Things at the Beach", "Ways to Cook Food", "Places to Spend Money",
                 "Things That are Round", "Things That are Square", "Things at Christmas", "Sounds of Animals",
